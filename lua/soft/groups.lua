...
M.setup = function()
	return {
		...
		Parameter = { fg = colors.purpleDefault },
		Statement = { link = "Keyword" },
		Conditional = { fg = colors.blue },
		Repeat = { fg = colors.blue },
		Label = { fg = colors.blue },
		Exception = { fg = colors.redFaded },
		...
		Type = { fg = colors.violet, italic = false },
		Class = { fg = colors.salmon },
		StorageClass = { fg = colors.blue },
		Structure = { fg = colors.yellow },
		TypeDef = { fg = colors.yellow },
		Special = { fg = colors.blue, italic = true },
		SpecialChar = { fg = colors.textDark },
		Tag = { fg = colors.textDark },
		Delimiter = { fg = colors.green },
		SpecialComment = { link = "Comment" },
		Debug = { fg = colors.textDark },
		Ignore = { fg = colors.textDark },
		Error = { fg = colors.red },
		Todo = { fg = colors.textFaded, bold = false, italic = true },
